 ...
 * @param $userId 用户ID
 * @param $desc   用户描述
 * @param $type   类型:类型: 4开地,5孵化蛋蛋 6增养动物 7收取小鸡 8收取蛋蛋 9升级狗 10 孵化机放蛋 11 出蛋 12 孵化机出鸡    13激活用户 14 转账 15确认收款  16打扫 17提现 18抽奖
 */
 ...
 * @param $userId 用户ID
 * @param $desc   用户描述
 * @param $type   类型:类型:1购买牲畜,2购买饲料,3购买激活码,4开地, 7收取小鸡 8收取蛋蛋 9升级狗 10 孵化机放蛋 11 出蛋 12 孵化机出鸡 //5绿地孵化。6，增养， 取消掉换别的日志
 */
//新日志。记录用户所有交易记录
